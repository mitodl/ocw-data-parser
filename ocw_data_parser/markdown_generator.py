...
def generate_md_for_course(master_json, destination):
    ...
    main_content = generate_main_content(loaded_master_json)
    destination = get_correct_path(destination) + "main_content.md"
    with open(destination, "w") as f:
        f.write(md(main_content))
